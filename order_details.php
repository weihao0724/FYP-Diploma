  ...
  <div class="container">
	...
	<table class="table">
			...
			<?php		
				$total_price = 0;
				$totalcus=0;
				$result = mysqli_query($connect,"SELECT * FROM customise WHERE Customer_ID = $id AND Payment_ID = '$pay_id'");
              ...
              <tr>
				...
				<td><a href="order_cus_details.php?id=<?php echo $rowcus['customiseid'];?>"><button class="button" style = "margin-top: 37%; margin-left: 20%;">Details</button></a></td>
          ...
          <table class="table">
			...
			<?php		
				...
				$result = mysqli_query($connect,"SELECT * FROM cart WHERE Customer_ID = '$id' AND Payment_ID = '$pay_id'");
              ...
              <tr>
                ...
                <td class="col-sm-1 col-md-1" style="text-align: center"><p class="price_table"><?php echo $result_cart["Qty"]; ?></p></td>
        ...
        <div class="shopping-cart-cart">
          <table>
            <tbody>
              ...
              <tr>
                <td style="width:100%"><a href="user_profile.php" ><button class="btn sqaure_bt light_theme_bt">Back to profile</button></a></td>			  
              </tr>
            </tbody>
          </table>
        </div>
