		...
		<div id="add-admin" class="">
			...
			<form name="addfrm" method="post" class="addform" action="">
				<p class="<?php echo (!empty($id_check)) ? 'has-error' : ''; ?>">
					...
					<input type="text" name="staff_id" value="<?php echo $row["Admin_ID"];?>">
				...
				<p>
					...
					<input type="date" name="staff_date" id="join_date" value="<?php echo $row["Staff_Join_Date"];?>" disabled>
				</p>
				<p class="<?php echo (!empty($email_check)) ? 'has-error' : ''; ?>">
					<label>Email:&nbsp;&nbsp;</label>
					<input type="email" name="staff_email" value="<?php echo $row["Staff_Email"];?>">
					<span id="valid-email"><?php echo $email_check; ?></span>
				</p>
				<p class="<?php echo (!empty($phone_check)) ? 'has-error' : ''; ?>">
					<label>Contact Number:&nbsp;</label>
					<input type="number" name="staff_contact" value="<?php echo $row["Staff_Contact_Num"];?>">
					<span id="valid-contact"><?php echo $phone_check; ?></span>
				</p>
				<p class="<?php echo (!empty($age_check)) ? 'has-error' : ''; ?>">
					<label>Age (>= 18 years old):&nbsp;</label>
					<input type="number" name="staff_age" value="<?php echo $row["Staff_Age"];?>">
