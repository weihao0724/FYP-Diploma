...
if(isset($_POST["savebtn"])) 	
{
	...
	{
		?>
			<script>console.log("Something went wrong. New category cannot be saved.")</script>
		<?php
	}
}
...
<!--div for adding a new category-->			
			<div id="add-category" class="">
				...
				<form class="addfrm" name="addfrm" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
					<p>
						<label>ID:</label>
						<input type="text" name="cate_id" value="<?php echo $count;?>" disabled>
					</p>
					...
					<p>
						...
						<textarea cols="60" rows="4" name="cate_desc"><?php echo $desc;?></textarea>
